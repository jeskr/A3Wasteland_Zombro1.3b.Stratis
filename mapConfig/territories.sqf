...
[
	...
	["TERRITORY_SHITTY_TOWN", "Shitty Town", 250, "TOWN"],
	["TERRITORY_RADIO_TOWER_CENTRAL", "Radio Tower Central", 250, "MILITARY"],
	["TERRITORY_STRATIS_AIRBASE_TOWN", "Stratis Airbase Town", 250, "MILITARY"]
]
