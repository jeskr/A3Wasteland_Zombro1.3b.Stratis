...
#define ITEM_CLEANUP_TIME (10*60) // Dropped player items cleanup time (30*60)
#define MONEY_CLEANUP_TIME (15*60) // Dropped money cleanup time (60*60)
#define STORE_CLEANUP_TIME (10*60) // Dropped store items cleanup time (30*60)
#define STORE_CLEANUP_RADIUS 7.5 // Radius in meters to scan near store NPCs for dropped items 7.5
#define DEBRIS_CLEANUP_TIME (10*60) // Vehicle crash crater/debris cleanup time (actual vehicle wreck cleanup is handled through description.ext parameters) (10*60)
#define GROUP_CLEANUP_TIME (1*60) // How long a group must have been empty before deleting it (1*60)
